        ...
        (createdChannel) => {
            createdChannel.setParent(categoryID).then(
                (settedParent) => {
                    ...
                    .setDescription("`bedankt voor het maken van uw sollicitatie!, u kunt uw sollicitatie alvast achterlaten, ons support team zal dit zo snel mogelijk behandelen")
                    .setTimestamp()
                    .setFooter("DutchFM Bot")
